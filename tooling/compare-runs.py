...
analytics = {"decomp_time": "scalability", "Analytics_JumpToMany": "imprecision"}
...
list_of_verbatim_rels = {"Verbatim_BlocksReachabilityMetric"}
...
if len(result_files) == 2:
    for rel in rels + ["has_output"]:
        ...
        print(
            f"For {rel} {len(not_in_file2)} not detected by config {result_files_simple[1]}: {not_in_file2}"
        )
